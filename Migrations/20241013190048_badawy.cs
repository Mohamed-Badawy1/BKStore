...
{
    /// <inheritdoc />
    public partial class badawy : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DelivaryStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryClientsID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TSubPrice = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
